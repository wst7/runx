...
use crate::{console::{add_log, clear_logs, get_logs, LogConsole}, value::js_value::JavascriptValueWithType};
...
impl JsEngine {
    ...
    pub async fn run(&self, code: &str) -> Result<Vec<Vec<JavascriptValueWithType>>, String> {
        ...
        self.run_code(&js_code).await
    }

    async fn run_code(&self, code: &str) -> Result<Vec<Vec<JavascriptValueWithType>>, String> {
        clear_logs();
